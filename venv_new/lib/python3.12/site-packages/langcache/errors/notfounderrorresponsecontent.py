...
from langcache.models import notfounderrortype as models_notfounderrortype
...
class NotFoundErrorResponseContentData(BaseModel):
    ...
    """
    type: models_notfounderrortype.NotFoundErrorType
    r"""Problem type URI for not-found errors."""
...
class NotFoundErrorResponseContent(LangCacheError):
    r"""The requested resource does not exist."""

    data: NotFoundErrorResponseContentData = field(hash=False)
