...
from langcache.models import forbiddenerrortype as models_forbiddenerrortype
...
class ForbiddenErrorResponseContentData(BaseModel):
    ...
    """
    type: models_forbiddenerrortype.ForbiddenErrorType
    r"""Problem type URI for authorization errors."""
...
class ForbiddenErrorResponseContent(LangCacheError):
    r"""The caller is authenticated but not allowed to access the requested resource."""

    data: ForbiddenErrorResponseContentData = field(hash=False)
