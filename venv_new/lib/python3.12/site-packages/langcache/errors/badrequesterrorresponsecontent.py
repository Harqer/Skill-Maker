...
from langcache.models import (
    badrequesterrortype as models_badrequesterrortype,
...
class BadRequestErrorResponseContentData(BaseModel):
    ...
    """
    type: models_badrequesterrortype.BadRequestErrorType
    r"""Problem type URI for bad request errors."""
    ...
    r"""Optional field-level validation errors."""


@dataclass(unsafe_hash=True)
class BadRequestErrorResponseContent(LangCacheError):
    r"""Request validation or input decoding failed."""
