...
from langcache.models import unexpectederrortype as models_unexpectederrortype
...
class UnexpectedErrorResponseContentData(BaseModel):
    ...
    """
    type: models_unexpectederrortype.UnexpectedErrorType
    r"""Problem type URI for unexpected internal errors."""
...
class UnexpectedErrorResponseContent(LangCacheError):
    r"""The service failed with an unexpected internal error."""
