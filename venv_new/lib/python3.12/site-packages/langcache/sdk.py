...
class LangCache(BaseSDK):
    ...
    def conversational_search(
        ...
        *,
        ...
        search_strategies: Optional[Iterable[models.SearchStrategy]] = None,
    ...
    ) -> models.ConversationalSearchResponseContent:
        r"""Searches the cache for entries using conversational context. When conversation context is provided, the query is reformulated before searching.
        ...
        :param attributes:
        :param max_results: The maximum number of results to return. Defaults to 1 if not specified.
        :param context: Conversation history in chronological order [Q1, Q2, Q3, ...]. When provided, the query is reformulated using CQR before searching.
        ...
        request = models.ConversationalSearchBody(
            prompt=prompt,
            similarity_threshold=similarity_threshold,
            search_strategies=utils.unmarshal(
                search_strategies, Optional[List[models.SearchStrategy]]
            ),
            attributes=utils.unmarshal(attributes, Optional[Dict[str, str]]),
            max_results=max_results,
            context=utils.unmarshal(context, Optional[List[str]]),
        )

        req = self._build_request(
            method="POST",
            path="/v1/caches/{cacheId}/conversations/search",
            base_url=base_url,
            ...
            _globals=models.ConversationalSearchGlobals(
                cache_id=self.sdk_configuration.globals.cache_id,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.ConversationalSearchBody
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ConversationalSearch",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ConversationalSearchResponseContent, http_res
            )
    ...
    async def conversational_search_async(
        self,
        *,
        prompt: str,
        similarity_threshold: Optional[float] = None,
    ...
    def delete_query(
        ...
        *,
        ...
        request = models.DeleteQueryRequest(
            attributes=utils.unmarshal(attributes, Dict[str, str]),
        )
